...
4. Ouvrir SQLite Manager **Bouton Firefoxn -> Outils -> SQLite Manager**
...
* Les données d'une table ont différents types, et toutes les valeurs d'un champ
  sont du même type ([list of data types](#datatypes))
...
***EXERCICE: Écrire une requête qui retourne
             The year, month, day, speciesID et weight en mg***
